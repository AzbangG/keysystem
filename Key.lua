...
local Config = {
    ...
    ServiceId       = 24902, -- Your PlatoBoost Service ID
    PlatoSecret     = "2f320d74-91c3-4991-a69f-c20f71eeafe3", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "Kop99ajA", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/AzbangG/MajekHub/refs/heads/main/No_Key_Kick_a_Lucky_Block", -- The raw URL of your main script
    ...
    HubName         = "MAJEK HUB", -- The main title shown at the top of the GUI
    HubDescription  = "WELCOME GUYS" -- The text shown below the title
}
